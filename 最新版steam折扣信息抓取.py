...
def steamsale0():
    ...
    for i in range(0,len(xfinal_namelist)):
        ...
        print("")
  '''
    if(len(xfinal_namelist)==len(xfinal_pricelist)==len(xfinal_pricenowlist)==len(xfinal_addresslist)==len(xfinal_photo)):
        file_path='C:\\Users\Administrator\\Desktop\\s1\\steamzhe0.csv'
